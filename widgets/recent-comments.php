					...
					if ( $comments ) {
						foreach ( $comments as $comment ) { ?>
							...
							<li>
								...
								<a href="<?php echo get_permalink($comment->comment_post_ID); ?>#comment-<?php echo $comment->comment_ID; ?>" title="<?php esc_html_e('Comment to','rowling'); echo ' ' . get_the_title($comment->comment_post_ID) . ', '; _e('posted','rowling'); echo ' ' . get_the_time(get_option('date_format')); ?>">
