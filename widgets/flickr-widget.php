...
class rowling_flickr_widget extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('id')); ?>"><?php esc_html_e('Flickr ID (use <a target="_blank" href="http://www.idgettr.com">idGettr</a>)', 'rowling'); ?>:
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Number of images to display', 'rowling'); ?>:
